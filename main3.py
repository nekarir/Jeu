...
def button_click(btn, row, col):
    global joueur
    global matrice
    btn.config(image=img_croix if joueur == 1 else img_circle, state=tk.DISABLED)
...
img_croix = PhotoImage(file = "no-symbol-computer-icons-clip-art-image-red-cross-5c401a9c0699b0d01f74ca1bdeb80b0a.png")
img_circle = PhotoImage(file = "NicePng_circle-border-png_107873.png")

btn1 = tk.Button(root, width=200, height=100, image=None, command=lambda: button_click(btn1, 0, 0))
btn1.grid(row=0, column=0, padx=5, pady=5)

btn2 = tk.Button(root, width=200, height=100, image=None, command=lambda: button_click(btn2, 0, 1))
btn2.grid(row=0, column=1, padx=5, pady=5)

btn3 = tk.Button(root, width=200, height=100, image=None, command=lambda: button_click(btn3, 0, 2))
btn3.grid(row=0, column=2, padx=5, pady=5)

btn4 = tk.Button(root, width=200, height=100, image=None, command=lambda: button_click(btn4, 1, 0))
btn4.grid(row=1, column=0, padx=5, pady=5)

btn5 = tk.Button(root, width=200, height=100, image=None, command=lambda: button_click(btn5, 1, 1))
btn5.grid(row=1, column=1, padx=5, pady=5)

btn6 = tk.Button(root, width=200, height=100, image=None, command=lambda: button_click(btn6, 1, 2))
btn6.grid(row=1, column=2, padx=5, pady=5)

btn7 = tk.Button(root, width=200, height=100, image=None, command=lambda: button_click(btn7, 2, 0))
btn7.grid(row=2, column=0, padx=5, pady=5)

btn8 = tk.Button(root, width=200, height=100, image=None, command=lambda: button_click(btn8, 2, 1))
btn8.grid(row=2, column=1, padx=5, pady=5)

btn9 = tk.Button(root, width=200, height=100, image=None, command=lambda: button_click(btn9, 2, 2))
